...
const submitCreateCatHandler = (e) => {
    ...
    let formData = formatCreateFormData(Object.fromEntries(new FormData(e.target).entries()));
...
const openModalHandler = (e) => {
    ...
    if (targetModalName === "createCat") {
        ...
        $createCatForm.addEventListener('change', (changeEvent) => {
            const formattedData = formatCreateFormData(Object.fromEntries(new FormData($createCatForm).entries()));
...
const openPopUpDetail = document.querySelector("[data-detail]");
...
const openEditModalHandler = (e) => {
    ...
    if (targetModalName === "editCat") {
        ...
        const submitEditCatHandler = (e) => {
            e.preventDefault();

            let formDataEdit = formatCreateFormData(Object.fromEntries(new FormData(e.target).entries()));
